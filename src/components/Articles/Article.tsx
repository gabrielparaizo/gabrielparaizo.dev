  ...
  return (
    <section className="flex flex-col gap-20 px-6 md:px-16 max-w-6xl mx-auto py-20 h-full">
      <header className="flex flex-col gap-3">
        ...
        <p className="text-zinc-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Id doloremque blanditiis fugit a cumque. Eligendi facilis veritatis provident totam magnam.</p>
      </header>
